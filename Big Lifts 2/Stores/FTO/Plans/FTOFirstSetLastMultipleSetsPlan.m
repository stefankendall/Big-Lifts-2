...
- (NSDictionary *)generate:(Lift *)lift {
    NSDictionary *firstSetLastSets = @{
            @1 : @[
                    [SetData dataWithReps:3 percentage:N(65) lift:lift],
                    [SetData dataWithReps:3 percentage:N(65) lift:lift],
                    [SetData dataWithReps:3 percentage:N(65) lift:lift],
                    [SetData dataWithReps:3 percentage:N(65) lift:lift optional: YES],
                    [SetData dataWithReps:3 percentage:N(65) lift:lift optional: YES]
            ],
            @2 : @[
                    ...
                    [SetData dataWithReps:3 percentage:N(70) lift:lift],
                    [SetData dataWithReps:3 percentage:N(70) lift:lift],
                    [SetData dataWithReps:3 percentage:N(70) lift:lift optional: YES],
                    [SetData dataWithReps:3 percentage:N(70) lift:lift optional: YES]
            ],
            @3 : @[
                    [SetData dataWithReps:3 percentage:N(75) lift:lift],
                    [SetData dataWithReps:3 percentage:N(75) lift:lift],
                    [SetData dataWithReps:3 percentage:N(75) lift:lift],
                    [SetData dataWithReps:3 percentage:N(75) lift:lift optional: YES],
                    [SetData dataWithReps:3 percentage:N(75) lift:lift optional: YES]
            ]
    };
